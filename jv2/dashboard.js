...
const albumTrackLists = {
  ...
  Karol: [
    ...
    { title: "Pero Tu", duration: "3:03" },
    { title: "Besties", duration: "2:42" },
    { title: "Gucci Los Panos", duration: "3:06" },
    { title: "TQG", duration: "3:18" },
    { title: "Tus Gafitas", duration: "2:47" },
    { title: "Ojos Ferrari", duration: "3:00" },
    { title: "Mercurio", duration: "2:40" },
    { title: "Gatubela", duration: "3:28" },
    { title: "Karmika", duration: "3:56" },
    { title: "Provenza", duration: "3:30" },
    { title: "Carolina", duration: "2:43" },
    { title: "Dananos La Amistad", duration: "3:03" },
    { title: "Amargura", duration: "2:51" },
    { title: "Cairo", duration: "3:18" },
    { title: "Manana Sera Bonito", duration: "3:30" }
  ],
  Rosalia: [
